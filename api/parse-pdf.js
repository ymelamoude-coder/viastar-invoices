module.exports = async function handler(req, res) {
  ...
  try {
    ...
    const prompt = [
      ...
      "CLOUD RUG: 500, 600, 700",
      "DAYTONA RUG: Champagne, Ivory, Silver",
      "ESCAPE RUG: 31, 70, 85",
      "GOYA RUG: Chevron Beige, Chevron Silver, Cubic Beige, Cubic Ivory, Stripes Beige, Stripes Silver",
      "GRANELLO RUG: Cream, Fendi",
      "JACARTA RUG: Zig Sand, Zig Silver",
      "LOMBOK RUG: 15 Beige, 15 Silver, 18 Beige, 18 Silver, 20 Beige",
      ...
      "For Modloft SKU ZSIL = Zig Silver → JACARTA RUG color='Zig Silver'",
      "For Modloft SKU ZSAN = Zig Sand → JACARTA RUG color='Zig Sand'",
      "",
      "LOMBOK RUG SKU COLOR CODES - READ CAREFULLY:",
      "The second part of Lombok SKU (after LBK-) indicates the EXACT color. Do NOT guess.",
      "  - 15B → color='15 Beige' (NOT Silver!)",
      "  - 15S → color='15 Silver'",
      "  - 18B → color='18 Beige' (NOT Silver!)",
      "  - 18S → color='18 Silver'",
      "  - 20B → color='20 Beige'",
      "The letter B always means Beige, the letter S always means Silver.",
      "Example: LBK-15B-S-RT-S_10x13 → LOMBOK RUG, color='15 Beige', Serged Edges, Rectangular, 10x13",
      "Example: LBK-18B-F-RT-S_8x10 → LOMBOK RUG, color='18 Beige', Folded Edges, Rectangular, 8x10",
      "",
      "SPOT RUG SKU COLOR CODES:",
      "  - ICE → Ice",
      "  - OIL → Oil",
      "  - RUS → Rust",
      "  - SND → Sand",
      "  - SLV → Silver",
      "Example: SPT-RUS-S-RT-S_8x10 → SPOT RUG, color='Rust', Serged Edges",
      "",
      "Modloft SKU example: JCT-ZSIL-F-RT-S-10X13 = JACARTA RUG, Zig Silver, Folded Edges, Rectangular, 10x13",
      "",
      "PRODUCT CODES: GOY=GOYA, MHL=MAHAL, LOM/LBK=LOMBOK, DAY=DAYTONA, LOP=LOOP, VLT/VLV=VELVET, ESC=ESCAPE, NAT=NATURE, NMD/NOM=NOMAD, RPL=REPLAY, ALL/ALR=ALLURE, ART=ARTISAN, BRS=BRISA, PNZ=PIENZA, TNZ/TAN=TANZANIA, SPT=SPOT, AUR=AUREN, GRN=GRANELLO, PUR=PURE, JCT=JACARTA, NCP=NEW CONCEPT, ANT=ANTIQUE PET, CLD=CLOUD, MAT=MATTEO. Always append RUG.",
      "",
