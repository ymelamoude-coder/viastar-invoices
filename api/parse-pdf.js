module.exports = async function handler(req, res) {
  ...
  try {
    ...
    const prompt = [
      ...
      "",
      "LOMBOK SKU COLOR CODES (important!):",
      "15B = 15 Beige",
      "15S = 15 Silver",
      "18B = 18 Beige",
      "18S = 18 Silver",
      "Example: LBK-15B-S-RT-S_10x13 = LOMBOK RUG, 15 Beige (NOT 18 Silver), Serged Edges, Rectangular, 10x13",
      "Example: LBK-18S-F-RT-S_8x10 = LOMBOK RUG, 18 Silver, Folded Edges, Rectangular, 8x10",
      "",
      "SPOT SKU COLOR CODES:",
      "ICE = Ice, OIL = Oil, RUS = Rust, SND = Sand, SLV = Silver",
      "Example: SPT-RUS-S-RT-S_8x10 = SPOT RUG, Rust, Serged Edges, Rectangular, 8x10",
      "",
