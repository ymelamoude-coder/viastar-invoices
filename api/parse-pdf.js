module.exports = async function handler(req, res) {
  ...
  try {
    ...
    const prompt = [
      ...
      "For Modloft SKU ZSIL = Zig Silver → JAKARTA RUG color='Zig Silver'",
      "For Modloft SKU ZSAN = Zig Sand → JAKARTA RUG color='Zig Sand'",
      "",
      ...
      "",
      "Modloft SKU example: JCT-ZSIL-F-RT-S-10X13 = JAKARTA RUG, Zig Silver, Folded Edges, Rectangular, 10x13",
      "",
