module.exports = async function handler(req, res) {
  ...
  try {
    ...
    const prompt = [
      ...
      "",
      "PRODUCT CODES: GOY=GOYA, MHL=MAHAL, LOM/LBK=LOMBOK, DAY=DAYTONA, LOP=LOOP, VLT/VLV=VELVET, ESC=ESCAPE, NAT=NATURE, NMD/NOM=NOMAD, RPL=REPLAY, ALL/ALR=ALLURE, ART=ARTISAN, BRS=BRISA, PNZ=PIENZA, TNZ/TAN=TANZANIA, SPT=SPOT, AUR=AUREN, GRN=GRANELLO, PUR=PURE, JCT=JACARTA, NCP=NEW CONCEPT, ANT=ANTIQUE PET. Always append RUG.",
      "",
